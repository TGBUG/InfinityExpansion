...
public final class Generators {
    ...
    private static final int HYDRO_ENERGY = 10;
    private static final int ADVANCED_HYDRO_ENERGY = 90;
    private static final int GEO_ENERGY = 70;
    private static final int ADVANCED_GEO_ENERGY = 420;
    private static final int BASIC_SOLAR_ENERGY = 18;
    private static final int ADVANCED_SOLAR_ENERGY = 300;
    private static final int CELESTIAL_ENERGY = 1500;
    private static final int VOID_ENERGY = 6000;
    private static final int INFINITY_ENERGY = 120_000;
    private static final int INFINITY_REACTOR_ENERGY = 240_000;
